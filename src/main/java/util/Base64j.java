...
public class Base64j {
    ...
    public static void encode(java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded) {
        ...
        while (raw.hasRemaining()) {
            ...
            raw.get(raw3, 0, rem);
            Base64j.encode3to4(enc4, raw3, rem, Base64j.NO_OPTIONS);
            encoded.put(enc4);
        }   // end input remaining
    }
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options)
        ...
        try {
            ...
            b64os = new Base64j.OutputStream(baos, ENCODE | options);
            if ((options & GZIP) != 0) {
                // Gzip
    ...
    public static byte[] encodeBytesToBytes(byte[] source) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes(source, 0, source.length, Base64j.NO_OPTIONS);
        } catch (java.io.IOException ex) {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if ((options & GZIP) != 0) {
            java.io.ByteArrayOutputStream baos = null;
            java.util.zip.GZIPOutputStream gzos = null;
            Base64j.OutputStream b64os = null;
    ...
    public static byte[] decode(byte[] source)
        ...
        byte[] decoded = null;
//        try {
        decoded = decode(source, 0, source.length, Base64j.NO_OPTIONS);
//        } catch( java.io.IOException ex ) {
//            assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
//        }
        return decoded;
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename)
        ...
        Base64j.OutputStream bos = null;
        try {
            bos = new Base64j.OutputStream(
                    new java.io.FileOutputStream(filename), Base64j.ENCODE);
    ...
    public static void decodeToFile(String dataToDecode, String filename)
        ...
        try {
            bos = new Base64j.OutputStream(
                    new java.io.FileOutputStream(filename), Base64j.DECODE);
    ...
    public static byte[] decodeFromFile(String filename)
        ...
        try {
            ...
            // Open a stream
            bis = new Base64j.InputStream(
                    new java.io.BufferedInputStream(
                            new java.io.FileInputStream(file)), Base64j.DECODE);
    ...
    public static String encodeFromFile(String filename)
        ...
        try {
            ...
            bis = new Base64j.InputStream(
                    new java.io.BufferedInputStream(
                            new java.io.FileInputStream(file)), Base64j.ENCODE);
            ...
            // Save in a variable to return
            encodedData = new String(buffer, 0, length, Base64j.PREFERRED_ENCODING);
    ...
    public static void encodeFileToFile(String infile, String outfile)
        ...
        String encoded = Base64j.encodeFromFile(infile);
    ...
    public static void decodeFileToFile(String infile, String outfile)
        ...
        byte[] decoded = Base64j.decodeFromFile(infile);
        java.io.OutputStream out = null;
        try {
            out = new java.io.BufferedOutputStream(
                    new java.io.FileOutputStream(outfile));
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    if (position >= bufferLength) { // Enough to output.
                        ...
                        int len = Base64j.decode4to3(buffer, 0, b4, 0, options);
                        out.write(b4, 0, len);
                        position = 0;
                    }   // end if: enough to output
