...
public class TipoContratoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value) {
        if (value != null && !value.isEmpty()) {
            return (TipoContrato) uiComponent.getAttributes().get(value);
        }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value) {
        ...
        if (value instanceof TipoContrato) {
            ...
            TipoContrato entity = (TipoContrato) value;

            if (entity != null && entity instanceof TipoContrato && entity.getId() != null) {
